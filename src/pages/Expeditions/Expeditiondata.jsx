...
export const expeditions = {
  ...
  },
  {
    ...
    description: "Drive towards the Black Sea coast and arrive in Batumi, Georgia’s vibrant seaside city. Stroll along the lively promenade, explore local landmarks, and unwind in the relaxed coastal atmosphere.Optional time to visit the Botanical Gardens, offering panoramic views and diverse flora.",
    // details:
  ...
  },
  {
    ...
    description: "Enjoy a scenic return drive to Tbilisi, transitioning from forested landscapes back into the capital’s urban energy.Spend the day exploring historic sites, vibrant markets, and cultural pockets of the city.A fitting final drive that brings together history, culture, and the joy of the open road.",
    // details:
  ...
  },
  {
    ...
    description: "Check out from the hotel and transfer for your onward flight.Depart Georgia carrying memories of mountain passes, coastal roads, historic towns, and a truly immersive self-drive journey.",
    // details:
    //   "Last-minute shopping and farewell dinner before your journey home.",
  },
    ],
    ...
    itinerary: [
      {
        ...
        description: "Arrive in Romania’s capital and ease into the journey.The day is kept light and flexible, allowing time to rest after travel or explore Bucharest’s historic streets and cafés at your own pace.",
      },
      {
        day: 2,
        title: "Bucharest to Sibiu via Transfăgărășan (264 km)",
        description: "Leave the city behind and head north onto one of Europe’s most iconic mountain roads. The Transfăgărășan climbs into the Făgăraș Mountains with sweeping curves, tunnels, and panoramic viewpoints. A relaxed picnic near the alpine section sets the pace before descending into Transylvania and reaching Sibiu by evening. A day defined entirely by the road.",
      },
       {
    day: 3,
    title: "Sibiu to Cund (76 km)",
    description: "Drive deeper into rural Transylvania, where rolling fields and forests replace city life. Near the village of Cund, enjoy a local experience rooted in the landscape, followed by a hands-on culinary session using regional ingredients. The afternoon is intentionally slow, offering time to absorb the stillness of the countryside.",
  },
  {
    day: 4,
    title: "Sighișoara and the Transylvanian Hills (76 km)",
    description: "Arrive in Sighișoara, one of Europe’s best-preserved medieval citadels, where cobbled streets and fortified walls tell stories of centuries past. Later, explore the surrounding countryside on e-bikes, moving through villages, meadows, and open hills at an unhurried pace.",
  },
  {
    day: 5,
    title: "Cund to Brașov via Viscri (155 km)",
    description: "Drive through Saxon Transylvania with a stop at Viscri, a UNESCO-listed village known for its fortified church and timeless rural character. Simple homes, uneven streets, and open landscapes offer a glimpse into a way of life that has endured for generations.By evening, arrive in Brașov, set against forested hills and medieval squares.",
  },
  {
    day: 6,
    title: "Brașov and Bran (30 km)",
    description: "Leave paved roads behind for a guided off-road experience through forest tracks and elevated clearings, reaching viewpoints rarely accessed by conventional vehicles.As evening approaches, visit Bran after hours, experiencing the site in a quieter, more atmospheric setting before continuing into the mountains.",
  },
  {
    day: 7,
    title: " Sinaia and the Wild",
    description: "Begin the day with Romania’s royal history at Peleș Castle, set against a dramatic mountain backdrop. Later, shift focus to nature with a guided wildlife observation experience from a forest hide, following strict ethical and safety practices. A day shaped by history, landscape, and silence.",
  },
  {
    day: 8,
    title: "Return to Bucharest via Slănic Prahova (140 km)",
    description: "Leave the mountains behind and drive south to one of Romania’s most striking natural spaces—an expansive underground salt mine with a scale unlike anything above ground. From here, continue back to Bucharest for a relaxed final evening.",
  },
  {
    day: 9,
    title: "Departure",
 ...
 southkorea : {
  ...
  },
  {
    ...
    description: "Begin the return drive to Seoul, a day shaped by long scenic stretches, rustic landscapes, and cultural reflections from the journey.Arrive in Seoul by evening for a relaxed final night.",
  },
  {
    day: 9,
    title: "Departure from Seoul",
    description: "Transfer to the airport for your return flight.Depart South Korea with memories of exceptional roads, layered history, coastal light, and deeply immersive experiences.",
  },
    ],
