  ...
  const allBlogs = [
    {
      ...
      subtitle:
        "Exploring Off-Beat Kerala: A Scenic Journey Beyond the Beaten Path",
  ...
  return (
    <Box sx={{ backgroundColor: "#fff" }}>
      ...
      <Container sx={{ py: { xs: 6, md: 10 } }}>
        <Grid container alignItems="center" columnSpacing={{ xs: 4, md: 10 }}>
          {/* LEFT TEXT */}
          <Grid
            item
            xs={12}
        ...
        >
          {displayedBlogs.map((blog) => (
            <Box key={blog.id}>
              ...
              {/* SUBTITLE */}
              <Typography
                sx={{ fontSize: 13, fontWeight: 600, color: "#464545", mb: 1 }}
              >
                {blog.subtitle}
              </Typography>
